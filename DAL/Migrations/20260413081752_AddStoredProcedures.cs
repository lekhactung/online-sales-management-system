...
END;";
            migrationBuilder.Sql(addCustomerProc);

            var deleteCustomerProc = @"
...
BEGIN
    ...
    END CATCH
END;";
            migrationBuilder.Sql(deleteCustomerProc);

            var updateCustomerProc = @"
...
BEGIN
    ...
    ELSE
        ...
        END
END;";
            migrationBuilder.Sql(updateCustomerProc);
...
END;";
            migrationBuilder.Sql(addCategoryProc);

            var updateCategoryProc = @"
...
END;";
            migrationBuilder.Sql(updateCategoryProc);

            var deleteCategoryProc = @"
...
BEGIN
    ...
    END CATCH
END;";
            migrationBuilder.Sql(deleteCategoryProc);
...
END;";
            migrationBuilder.Sql(addProductProc);

            var deleteProductProc = @"
...
BEGIN
    ...
    END CATCH
END;";
            migrationBuilder.Sql(deleteProductProc);

            var getAllProductsProc = @"
...
END;";
            migrationBuilder.Sql(getAllProductsProc);

            var getOrdersByCustomerProc = @"
...
END;";
            migrationBuilder.Sql(getOrdersByCustomerProc);
        }
